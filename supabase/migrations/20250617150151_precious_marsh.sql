/*
  # Clear all businesses and add 4 businesses near Venizelou station

  1. Changes
    - Delete all existing businesses and related data
    - Add 4 new businesses near Venizelou metro station
    - Include business photos and hours for each business

  2. New Businesses
    - Φαρμακείο Βενιζέλου (Pharmacy)
    - Καφετέρια Central (Cafe)
    - Εστιατόριο Μεσογειακό (Restaurant)
    - Mini Market Express (Grocery)
*/
